...
public class RegistroRest {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public RespuestaDTO listarRegistrosEntreFechas(@FormParam(value = "cod") String cod,
			@FormParam(value = "ced") int ced) {
	 ...
	 * 
	 * @param idReg,
	 *            es el id del registro a aprobar
	 * @param coment,
	 *            es el comentario del registro a aprobar
	 * @author Brayan Giraldo Correo : giraldo97@outlook.com
	 */
	@POST
	...
	/**
	 * Método para editar un registro no aprobado
	 * 
	 * @author Brian David Tafur Londoño<br/>
	 *         email: tafur2401@gmail.com <br/>
	 ...
	 * @return la respuesta al uso del servicio y su código de confirmación
	 */
	@POST
	@Path("/editarregistro")
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	@Produces(MediaType.APPLICATION_JSON)
	public RespuestaDTO editarRegistro(@FormParam(value = "id") long id,
			@FormParam(value = "coment") String comentario) {
		registroEJB.editarRegistro(id, comentario);
		return new RespuestaDTO(null, "Registro editado con éxito", "00");
	}
